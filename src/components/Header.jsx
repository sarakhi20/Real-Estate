    ...
    <div className='min-h-screen mb-4 bg-cover bg-center flex items-center w-full overflow-hidden'style={{backgroundImage:"url('\header_img.png')"}} id='Header'>
        ...
        <motion.div initial={{opacity:0, y:100}} transition={{duration:1.5}} whileInView={{opacity:1, y:0}} viewport={{once:true}} className='container text-center mx-auto py-4 px-6 md:px-20 lg:px-32 text-white'>
            ...
            <div className='space-x-6 mt-16'>
                <a href='#Projects' className='border border-white text-white no-underline px-8 py-3 rounded'>Projects</a>
                <a href='#Contact' className='border border-white text-white no-underline bg-blue-500 px-8 py-3 rounded'>Contact Us</a>
                {/* <Link to='/Project' className='border border-white px-8 py-3 rounded'>Projects</Link> */}
            </div>
     </motion.div>
     </div>
