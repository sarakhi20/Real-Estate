...
const Payment = () => {
  ...
  return (
    ...
    <input type="number"placeholder="Enter Amount"class="w-50 p-2 pl-10 text-sm text-gray-700 border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600" />
    <button class="w-50 px-4 py-2 mt-4 text-sm text-white bg-blue-600 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-600"> 
    Submit
